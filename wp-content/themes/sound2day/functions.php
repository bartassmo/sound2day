<?php
/**
 * sound2day functions and definitions
 *
...
if ( ! function_exists( 'sound2day_setup' ) ) :
	/**
	 ...
	 */
	function sound2day_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on sound2day, use a find and replace
		 * to change 'sound2day' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'sound2day', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'sound2day_custom_background_args', array(
...
add_action( 'after_setup_theme', 'sound2day_setup' );
 ...
 */
function sound2day_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'sound2day_content_width', 640 );
}
add_action( 'after_setup_theme', 'sound2day_content_width', 0 );
...
add_action( 'wp_enqueue_scripts', 'sound2day_scripts' );
